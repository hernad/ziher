...
static ZH_GENC_FUNC( zh_p_macropush )
{
   ...
   fprintf( cargo->yyc, "\tZH_P_MACROPUSH, %u,\n", pFunc->pCode[ nPCodePos + 1 ] );
   return 2;
}
...
static ZH_GENC_FUNC( zh_p_macropushref )
{
   ...
   fprintf( cargo->yyc, "\tZH_P_MACROPUSHREF,\n" );
   return 1;
}
...
static ZH_GENC_FUNC( zh_p_macrofunc )
{
   ZH_SYMBOL_UNUSED( pFunc );
   ZH_SYMBOL_UNUSED( nPCodePos );

   fprintf( cargo->yyc, "\tZH_P_MACROFUNC, %u, %u,\n",
            pFunc->pCode[ nPCodePos + 1 ], pFunc->pCode[ nPCodePos + 2 ] );
   return 3;
}
...
static ZH_GENC_FUNC( zh_p_macroarraygen )
{
   ZH_SYMBOL_UNUSED( pFunc );
   ZH_SYMBOL_UNUSED( nPCodePos );

   fprintf( cargo->yyc, "\tZH_P_MACROARRAYGEN, %u, %u,\n",
            pFunc->pCode[ nPCodePos + 1 ], pFunc->pCode[ nPCodePos + 2 ] );
   return 3;
}
...
static ZH_GENC_FUNC( zh_p_macropushlist )
{
   ...
   fprintf( cargo->yyc, "\tZH_P_MACROPUSHLIST, %u,\n", pFunc->pCode[ nPCodePos + 1 ] );
   return 2;
}
...
static ZH_GENC_FUNC( zh_p_macropushindex )
{
   ...
   fprintf( cargo->yyc, "\tZH_P_MACROPUSHINDEX,\n" );
   return 1;
}
...
static ZH_GENC_FUNC( zh_p_macropushpare )
{
   ...
   fprintf( cargo->yyc, "\tZH_P_MACROPUSHPARE, %u,\n", pFunc->pCode[ nPCodePos + 1 ] );
   return 2;
}
...
static ZH_GENC_FUNC( zh_p_macropushaliased )
{
   ...
   fprintf( cargo->yyc, "\tZH_P_MACROPUSHALIASED, %u,\n", pFunc->pCode[ nPCodePos + 1 ] );
   return 2;
}
