...
{
   {
      ...
      "zh_xgrab nem tud memóriát foglalni",
      "zh_xrealloc NULL mutatóval került meghívásra",
      "zh_xrealloc hibás mutatóval került meghívásra",
      "zh_xrealloc nem tud memóriát újrafoglalni",
      "zh_xfree hibás mutatóval került meghívásra",
      "zh_xfree NULL mutatóval került meghívásra",
      ...
      "zh_xgrab nulla bájt foglalására lett utasítva",
      "zh_xrealloc nulla bájt újrafoglalására lett utasítva",
      "zh_xalloc nulla bájt foglalására lett utasítva",
