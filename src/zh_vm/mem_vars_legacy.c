...
ZH_FUNC_TRANSLATE( __MCLEAR   , __MVCLEAR )
ZH_FUNC_TRANSLATE( __MRELEASE , __MVRELEASE )
ZH_FUNC_TRANSLATE( __MXRELEASE, __MVXRELEASE )
ZH_FUNC_TRANSLATE( __MSAVE    , __MVSAVE )
ZH_FUNC_TRANSLATE( __MRESTORE , __MVRESTORE )
