...
//ZH_FUNC_EXTERN( SQLMIX );
//ZH_FUNC_EXTERN( SQLMIX_GETFUNCTABLE );


//ZH_FUNC_EXTERN( RDDREGISTER );
//ZH_FUNC_EXTERN( RDDSETDEFAULT );

//ZH_FUNC_EXTERN( SQLBASE );
//ZH_FUNC_EXTERN( SQLBASE_GETFUNCTABLE );

//ZH_FUNC_EXTERN(ZHOBJECT);
//ZH_FUNC_EXTERN(__CLSADDMSG);
//ZH_FUNC_EXTERN(__CLSLOCKDEF);
//ZH_FUNC_EXTERN(ZHCLASS);
//ZH_FUNC_EXTERN(__OBJDERIVEDFROM);
//ZH_FUNC_EXTERN(ZHOBJECT_NEW);
//ZH_FUNC_EXTERN(ZHOBJECT_INIT); 
//ZH_FUNC_EXTERN(ZHOBJECT_ERROR);
//ZH_FUNC_EXTERN(ZH_DEFAULT);
//ZH_FUNC_EXTERN(__GETMESSAGE);
//ZH_FUNC_EXTERN(__ERRRT_SBASE);
//ZH_FUNC_EXTERN(ZH_LEFTEQ);
//ZH_FUNC_EXTERN(__CLSUNLOCKDEF);
//ZH_FUNC_EXTERN(ZHOBJECT_DFTONERROR);
...
static ZH_SYMBOL symbols[] = {
   ...
   //{ "ERROR_VMINIT", { ZH_FS_PUBLIC }, { ZH_FUNCNAME( ERROR_VMINIT ) }, NULL },
    ...
    //{ "RDDREGISTER", { ZH_FS_PUBLIC }, { ZH_FUNCNAME( RDDREGISTER ) }, NULL },
    //{ "RDDSETDEFAULT", { ZH_FS_PUBLIC }, { ZH_FUNCNAME( RDDSETDEFAULT ) }, NULL },

   /*
   //{ "WORD",      { ZH_FS_PUBLIC }, { ZH_FUNCNAME( WORD )      }, NULL },
   { "ZHOBJECT",      { ZH_FS_PUBLIC }, { ZH_FUNCNAME( ZHOBJECT )      }, NULL },
   { " __CLSADDMSG",      { ZH_FS_PUBLIC }, { ZH_FUNCNAME(  __CLSADDMSG ) }, NULL },
   
   { "FUNC_HELLO_ZIHER_2", { ZH_FS_PUBLIC }, { ZH_FUNCNAME( FUNC_HELLO_ZIHER_2 ) }, NULL },
   
   { "S_PYPOZIVA", { ZH_FS_PUBLIC | ZH_FS_MEMVAR }, { NULL }, NULL },   
   { "__CLSLOCKDEF", { ZH_FS_PUBLIC }, { ZH_FUNCNAME( __CLSLOCKDEF ) }, NULL },
   { "ZHCLASS", { ZH_FS_PUBLIC }, { ZH_FUNCNAME( ZHCLASS ) }, NULL },
   { "__OBJDERIVEDFROM", { ZH_FS_PUBLIC }, { ZH_FUNCNAME( __OBJDERIVEDFROM ) }, NULL },
   //{ "ZHOBJECT_NEW", { ZH_FS_STATIC | ZH_FS_LOCAL }, { ZH_FUNCNAME( ZHOBJECT_NEW ) }, NULL },
   //{ "ZHOBJECT_INIT", { ZH_FS_STATIC | ZH_FS_LOCAL }, { ZH_FUNCNAME( ZHOBJECT_INIT ) }, NULL },
   //{ "ZHOBJECT_ERROR", { ZH_FS_STATIC | ZH_FS_LOCAL }, { ZH_FUNCNAME( ZHOBJECT_ERROR ) }, NULL },
   { "ZH_DEFAULT", { ZH_FS_PUBLIC }, { ZH_FUNCNAME( ZH_DEFAULT ) }, NULL },
   { "__GETMESSAGE", { ZH_FS_PUBLIC }, { ZH_FUNCNAME( __GETMESSAGE ) }, NULL },
   { "__ERRRT_SBASE", { ZH_FS_PUBLIC }, { ZH_FUNCNAME( __ERRRT_SBASE ) }, NULL },
   { "ZH_LEFTEQ", { ZH_FS_PUBLIC }, { ZH_FUNCNAME( ZH_LEFTEQ ) }, NULL },
   { "__CLSUNLOCKDEF", { ZH_FS_PUBLIC }, { ZH_FUNCNAME( __CLSUNLOCKDEF ) }, NULL },
   //{ "ZHOBJECT_DFTONERROR", { ZH_FS_STATIC | ZH_FS_LOCAL }, { ZH_FUNCNAME( ZHOBJECT_DFTONERROR ) }, NULL },
   //{ "(_INITSTATICS00001)", { ZH_FS_INITEXIT | ZH_FS_LOCAL }, { ZH_INITSTATICS_FUNCNAME() }, NULL },
   { "ADDINLINE", { ZH_FS_PUBLIC | ZH_FS_MESSAGE }, { NULL }, NULL },
   { "ADDMETHOD", { ZH_FS_PUBLIC | ZH_FS_MESSAGE }, { NULL }, NULL },
   { "SETONERROR", { ZH_FS_PUBLIC | ZH_FS_MESSAGE }, { NULL }, NULL },
   { "ERROR", { ZH_FS_PUBLIC | ZH_FS_MESSAGE }, { NULL }, NULL },
   { "CLASSNAME", { ZH_FS_PUBLIC | ZH_FS_MESSAGE }, { NULL }, NULL },
   { "CREATE", { ZH_FS_PUBLIC | ZH_FS_MESSAGE }, { NULL }, NULL },
   { "INSTANCE", { ZH_FS_PUBLIC | ZH_FS_MESSAGE }, { NULL }, NULL },
   { "INIT", { ZH_FS_PUBLIC | ZH_FS_MESSAGE }, { NULL }, NULL },
   { "MSGNOTFOUND", { ZH_FS_PUBLIC | ZH_FS_MESSAGE }, { NULL }, NULL },
   */
