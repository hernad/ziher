  ...
  s_vmInitPozivCount ++;
    ...
    */
      ...
      if (s_vmInitPozivCount < 1000) {
         ...
         zh_INITSTATICS_URL_ZH();
zh_INITSTATICS_SMTPCLI_ZH();
zh_INITSTATICS_MAIL_ZH();
zh_INITSTATICS_LOG_ZH();
zh_INITSTATICS_ENCURL_ZH();
zh_INITSTATICS_ENCQP_ZH();
zh_INITSTATICS_ENCODER_ZH();
zh_INITSTATICS_ENCB64_ZH();
zh_INITSTATICS_CLIENT_ZH();
zh_INITSTATICS_CGI_ZH();
zh_INITSTATICS_CLS_TPQSERVER_ZH();
...
zh_INITSTATICS_CLS_ZHTEXTLINE_ZH();
zh_INITSTATICS_CLS_ZHMENUSYS_ZH();
zh_INITSTATICS_CLS_ZHMEMOEDITOR_ZH();
zh_INITSTATICS_CLS_ZHGETLIST_ZH();
zh_INITSTATICS_CLS_ZHEDITOR_ZH();
zh_INITSTATICS_CLS_ZH_POPUPMENU_ZH();
zh_INITSTATICS_CLS_ZH_GET_ZH();
zh_INITSTATICS_CLS_TOPBARMENU_ZH();
zh_INITSTATICS_CLS_TBROWSE_ZH();
zh_INITSTATICS_CLS_TBCOLUMN_ZH();
zh_INITSTATICS_CLS_SCROLL_BAR_ZH();
zh_INITSTATICS_CLS_RADIO_GRP_ZH();
zh_INITSTATICS_CLS_RADIO_BUTTON_ZH();
zh_INITSTATICS_CLS_PUSH_BUTTON_ZH();
zh_INITSTATICS_CLS_POPUPMENU_ZH();
zh_INITSTATICS_CLS_MENUITEM_ZH();
zh_INITSTATICS_CLS_LISTBOX_ZH();
zh_INITSTATICS_CLS_GET_ZH();
zh_INITSTATICS_CLS_CHECKBOX_ZH();
zh_INITSTATICS_ALERT_FUNC_ZH();
zh_INITSTATICS_ZHOBJECT_FUNC_ZH();
zh_INITSTATICS_ZHCLASS_FUNC_ZH();
zh_INITSTATICS_T_SYMBOL_ZH();
zh_INITSTATICS_T_SCALAR_ZH();
zh_INITSTATICS_PROFILER_ZH();
zh_INITSTATICS_NOOP_ZH();
zh_INITSTATICS_ZH_INI_ZH();
zh_INITSTATICS_T_PERSIST_ZH();
zh_INITSTATICS_TBRWTEXT_ZH();
zh_INITSTATICS_DEBUGGER_ZH();
zh_INITSTATICS_DBGTWIN_ZH();
zh_INITSTATICS_DBGTOBJ_ZH();
zh_INITSTATICS_DBGTMITM_ZH();
zh_INITSTATICS_DBGTMENU_ZH();
zh_INITSTATICS_DBGTINP_ZH();
zh_INITSTATICS_DBGTHSH_ZH();
zh_INITSTATICS_DBGTARR_ZH();
zh_INITSTATICS_DBGBRWSR_ZH();
zh_INITSTATICS_URL_ZH();
zh_INITSTATICS_SMTPCLI_ZH();
zh_INITSTATICS_MAIL_ZH();
zh_INITSTATICS_LOG_ZH();
...
zh_INITSTATICS_VIRM_EXPORT_BANKE_ZH();
zh_INITSTATICS_T_VIRM_MOD_ZH();
zh_INITSTATICS_T_POS_MOD_ZH();
...
zh_INITSTATICS_FIN_NALOG_CLS_ZH();
...
zh_INITSTATICS_FAKT_INVETURA_INIT_ZH();
zh_INITSTATICS_FAKT_GENERACIJA_DOKUMENTA_ZH();
zh_INITSTATICS_FAKT_FTXT_ZH();
zh_INITSTATICS_FAKT_FISKALNI_RACUN_ZH();
zh_INITSTATICS_FAKT_DOKUMENTI_ZH();
zh_INITSTATICS_FAKT_DOKUMENT_ZH();
zh_INITSTATICS_FAKT_COLUMN_ZH();
zh_INITSTATICS_BROWSE_FAKT_DOKUMENTI_ZH();
zh_INITSTATICS_UI2_WINDOWS_ZH();
zh_INITSTATICS_UNICODE_ZH();
...
zh_INITSTATICS_CLS_DOK_ATTR_ZH();
...
zh_INITSTATICS_UI_MAIN_SCREEN_ZH();
