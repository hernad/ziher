 ...
 * Copyright 2008-2009 Viktor Szakats (vszakats.net/ziher) (zh_osEncode(), zh_osDecode())
 *
...
static const char * is_devicename( const char * szFileName )
{
   ...
   {
#if defined( ZH_OS_OS2 ) || defined( ZH_OS_WIN ) || defined( ZH_OS_DOS )
...
static char * zh_set_PRINTFILE_default( void )
{
   ...
   return zh_strdup( "PRN" );
#elif defined( ZH_OS_WIN ) || defined( ZH_OS_OS2 )
