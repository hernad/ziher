 ...
 */
#if ! defined( ZH_NO_DEFAULT_API_MACROS ) && ! defined( _ZH_API_MACROS_ )
#  define _ZH_API_MACROS_
#endif

#if ! defined( ZH_NO_DEFAULT_STACK_MACROS ) && ! defined( _ZH_STACK_MACROS_ )
#  define _ZH_STACK_MACROS_
#endif

#if ! defined( _ZH_API_INTERNAL_ )
#  define _ZH_API_INTERNAL_
#endif
