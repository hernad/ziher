...
static HB_PP_TOKEN s_dm075[ 1 ] = {
   { NULL       , NULL       , "HB_VER_COMMIT_REV",  17, 0, 0xc015, 0 }
};
static HB_PP_TOKEN s_dr075[ 1 ] = {
   { NULL       , NULL       , "2001051035",        10, 0, 0xc02a, 0 }
};
static HB_PP_TOKEN s_dm076[ 1 ] = {
   { NULL       , NULL       , "HB_VER_COMMIT_YEAR",  18, 0, 0xc015, 0 }
};
static HB_PP_TOKEN s_dr076[ 1 ] = {
   { NULL       , NULL       , "2020",               4, 0, 0xc02a, 0 }
};
static HB_PP_TOKEN s_dm077[ 1 ] = {
   { NULL       , NULL       , "HB_VER_COMMIT_INFO",  18, 0, 0xc015, 0 }
};
static HB_PP_TOKEN s_dr077[ 12 ] = {
   { s_dr077 + 1, NULL       , "2020",               4, 0, 0xc02a, 0 },
   { s_dr077 + 2, NULL       , "-",                  1, 0, 0xc051, 0 },
   { s_dr077 + 3, NULL       , "01",                 2, 0, 0xc02a, 0 },
   { s_dr077 + 4, NULL       , "-",                  1, 0, 0xc051, 0 },
   { s_dr077 + 5, NULL       , "05",                 2, 0, 0xc02a, 0 },
   { s_dr077 + 6, NULL       , "11",                 2, 1, 0xc02a, 0 },
   { s_dr077 + 7, NULL       , ":",                  1, 0, 0xc03a, 0 },
   { s_dr077 + 8, NULL       , "35",                 2, 0, 0xc02a, 0 },
   { s_dr077 + 9, NULL       , ":",                  1, 0, 0xc03a, 0 },
   { s_dr077 +10, NULL       , "55",                 2, 0, 0xc02a, 0 },
   { s_dr077 +11, NULL       , "+",                  1, 1, 0xc050, 0 },
   { NULL       , NULL       , "0100",               4, 0, 0xc02a, 0 }
};
static HB_PP_TOKEN s_dm078[ 1 ] = {
   { NULL       , NULL       , "HB_VER_ORIGIN_URL",  17, 0, 0xc015, 0 }
};
static HB_PP_TOKEN s_dr078[ 10 ] = {
   { s_dr078 + 1, NULL       , "git",                3, 0, 0xc015, 0 },
   { s_dr078 + 2, NULL       , "@",                  1, 0, 0xc038, 0 },
   { s_dr078 + 3, NULL       , "github",             6, 0, 0xc015, 0 },
   { s_dr078 + 4, NULL       , ".",                  1, 0, 0xc01c, 0 },
   { s_dr078 + 5, NULL       , "com",                3, 0, 0xc015, 0 },
   { s_dr078 + 6, NULL       , ":",                  1, 0, 0xc03a, 0 },
   { s_dr078 + 7, NULL       , "hernad",             6, 0, 0xc015, 0 },
   { s_dr078 + 8, NULL       , "/",                  1, 0, 0xc053, 0 },
   { s_dr078 + 9, NULL       , "harbour",            7, 0, 0xc015, 0 },
   { NULL       , NULL       , "/",                  1, 0, 0xc053, 0 }
};
static HB_PP_TOKEN s_dm079[ 1 ] = {
   { NULL       , NULL       , "HB_VER_COMMIT_ID_SHORT",  22, 0, 0xc015, 0 }
};
static HB_PP_TOKEN s_dr079[ 2 ] = {
   { s_dr079 + 1, NULL       , "45",                 2, 0, 0xc02a, 0 },
   { NULL       , NULL       , "f9dd75",             6, 0, 0xc015, 0 }
};
static HB_PP_TOKEN s_dm080[ 1 ] = {
   { NULL       , NULL       , "HB_VER_COMMIT_ID",  16, 0, 0xc015, 0 }
};
static HB_PP_TOKEN s_dr080[ 2 ] = {
   { s_dr080 + 1, NULL       , "45",                 2, 0, 0xc02a, 0 },
   { NULL       , NULL       , "f9dd7503aff53d2510b88ce2bf56fd5e4a2461",  38, 0, 0xc015, 0 }
};
static const HB_PP_DEFRULE s_def[ 80 ] = {
...
static HB_PP_TOKEN s_cm279[ 7 ] = {
   ...
   { s_cm279 + 4, NULL       , "hb",                 2, 0, 0xc015, 0 },
...
static HB_PP_TOKEN s_cm280[ 7 ] = {
   { s_cm280 + 1, NULL       , "DO",                 2, 1, 0xc015, 0 },
   { s_cm280 + 2, NULL       , "proc",               4, 0, 0xe001, 1 },
   { s_cm280 + 3, NULL       , ".",                  1, 0, 0xc01c, 0 },
   { s_cm280 + 4, NULL       , "prg",                3, 0, 0xc015, 0 },
   { NULL       , s_cm280 + 5, "[",                  1, 1, 0xe007, 0 },
   { s_cm280 + 6, NULL       , "WITH",               4, 0, 0xc015, 0 },
   { NULL       , NULL       , "p",                  1, 0, 0xe002, 2 }
};
static HB_PP_TOKEN s_cr280[ 5 ] = {
   { s_cr280 + 1, NULL       , "do",                 2, 1, 0xc015, 0 },
   { s_cr280 + 2, NULL       , "proc",               4, 1, 0xc00b, 1 },
   { NULL       , s_cr280 + 3, "[",                  1, 1, 0xc012, 0 },
   { s_cr280 + 4, NULL       , "WITH",               4, 1, 0xc015, 0 },
   { NULL       , NULL       , "p",                  1, 1, 0xc00b, 2 }
};
static HB_PP_TOKEN s_cm281[ 8 ] = {
   { s_cm281 + 1, NULL       , "NEXT",               4, 1, 0xc015, 0 },
   { s_cm281 + 2, NULL       , "v",                  1, 0, 0xe001, 0 },
   { s_cm281 + 5, s_cm281 + 3, "[",                  1, 1, 0xe007, 0 },
   { s_cm281 + 4, NULL       , "TO",                 2, 0, 0xc015, 0 },
   { NULL       , NULL       , "x",                  1, 0, 0xe001, 0 },
   { NULL       , s_cm281 + 6, "[",                  1, 1, 0xe007, 0 },
   { s_cm281 + 7, NULL       , "STEP",               4, 0, 0xc015, 0 },
   { NULL       , NULL       , "s",                  1, 0, 0xe001, 0 }
};
static HB_PP_TOKEN s_cr281[ 1 ] = {
   { NULL       , NULL       , "next",               4, 1, 0xc015, 0 }
};
static HB_PP_TOKEN s_cm282[ 3 ] = {
   { s_cm282 + 1, NULL       , "ENDFOR",             6, 1, 0xc015, 0 },
   { NULL       , s_cm282 + 2, "[",                  1, 1, 0xe007, 0 },
   { NULL       , NULL       , "x",                  1, 0, 0xe004, 0 }
};
...
static HB_PP_TOKEN s_cm283[ 2 ] = {
   { s_cm283 + 1, NULL       , "ENDCASE",            7, 1, 0xc015, 0 },
   { NULL       , NULL       , "x",                  1, 0, 0xe004, 0 }
};
...
static HB_PP_TOKEN s_cm284[ 2 ] = {
   { s_cm284 + 1, NULL       , "ENDIF",              5, 1, 0xc015, 0 },
   { NULL       , NULL       , "x",                  1, 0, 0xe004, 0 }
};
...
static HB_PP_TOKEN s_cm285[ 2 ] = {
   { s_cm285 + 1, NULL       , "ENDDO",              5, 1, 0xc015, 0 },
   { NULL       , NULL       , "x",                  1, 0, 0xe004, 0 }
};
static HB_PP_TOKEN s_cr285[ 1 ] = {
   { NULL       , NULL       , "enddo",              5, 1, 0xc015, 0 }
};
static HB_PP_TOKEN s_cm286[ 2 ] = {
   { s_cm286 + 1, NULL       , "END",                3, 1, 0xc015, 0 },
   { NULL       , NULL       , "x",                  1, 0, 0xe001, 0 }
};
static HB_PP_TOKEN s_cr286[ 1 ] = {
   { NULL       , NULL       , "end",                3, 1, 0xc015, 0 }
};
static HB_PP_TOKEN s_cm287[ 3 ] = {
   { s_cm287 + 1, NULL       , "DO",                 2, 1, 0xc015, 0 },
   { s_cm287 + 2, NULL       , "WHILE",              5, 1, 0xc015, 0 },
   { NULL       , NULL       , "exp",                3, 0, 0xe001, 1 }
};
static HB_PP_TOKEN s_cr287[ 2 ] = {
   { s_cr287 + 1, NULL       , "while",              5, 1, 0xc015, 0 },
   { NULL       , NULL       , "exp",                3, 1, 0xc00b, 1 }
};
...
static HB_PP_TOKEN s_cm291[ 2 ] = {
   { s_cm291 + 1, NULL       , "END",                3, 1, 0xc015, 0 },
   { NULL       , NULL       , "SEQUENCE",           8, 1, 0xc015, 0 }
};
static HB_PP_TOKEN s_cr291[ 1 ] = {
   { NULL       , NULL       , "endsequence",       11, 1, 0xc015, 0 }
};
static const HB_PP_DEFRULE s_cmd[ 291 ] = {
   ...
   { s_cm286, s_cr286, 2, 0, 0x0000 },
   { s_cm287, s_cr287, 2, 1, 0x0000 },
   { s_cm288, s_cr288, 2, 0, 0x0000 },
   { s_cm289, s_cr289, 2, 0, 0x0000 },
   { s_cm290, s_cr290, 2, 0, 0x0000 },
   { s_cm291, s_cr291, 2, 0, 0x0000 }
};


void hb_pp_setStdRules( PHB_PP_STATE pState )
{
   hb_pp_initRules( &pState->pDefinitions, &pState->iDefinitions, s_def, 80 );
   hb_pp_initRules( &pState->pTranslations, &pState->iTranslations, NULL, 0 );
   hb_pp_initRules( &pState->pCommands, &pState->iCommands, s_cmd, 291 );
}
