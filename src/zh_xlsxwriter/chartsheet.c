...
*/
ZH_FUNC( LXW_CHARTSHEET_NEW )
{ 
   lxw_worksheet_init_data *init_data = zh_parptr( 1 ) ;

   zh_retptr( lxw_chartsheet_new(init_data) ); 
}
...
*/
ZH_FUNC( LXW_CHARTSHEET_FREE )
{ 
   lxw_chartsheet *chartsheet = zh_parptr( 1 ) ;
...
*/
ZH_FUNC( LXW_CHARTSHEET_ASSEMBLE_XML_FILE )
{ 
   lxw_chartsheet *self = zh_parptr( 1 ) ;
...
*/
ZH_FUNC( CHARTSHEET_SET_CHART_OPT )
{ 
   lxw_chartsheet *self = zh_parptr( 1 ) ;
   lxw_chart *chart = zh_parptr( 2 ) ;
   lxw_image_options *user_options = zh_parptr( 3 ) ;

   zh_retni( chartsheet_set_chart_opt(self, chart, user_options) ); 
}
...
*/
ZH_FUNC( CHARTSHEET_SET_CHART )
{ 
   lxw_chartsheet *self = zh_parptr( 1 ) ;
   lxw_chart *chart = zh_parptr( 2 ) ;

   zh_retni( chartsheet_set_chart(self, chart) ); 
}
...
*/
ZH_FUNC( CHARTSHEET_SET_FIRST_SHEET )
{ 
   lxw_chartsheet *self = zh_parptr( 1 ) ;
...
*/
ZH_FUNC( CHARTSHEET_SET_TAB_COLOR )
{ 
   lxw_chartsheet *self = zh_parptr( 1 ) ;
...
*/
ZH_FUNC( CHARTSHEET_SET_PORTRAIT )
{ 
   lxw_chartsheet *self = zh_parptr( 1 ) ;
...
*/
ZH_FUNC( CHARTSHEET_SET_LANDSCAPE )
{ 
   lxw_chartsheet *self = zh_parptr( 1 ) ;
...
*/
ZH_FUNC( CHARTSHEET_SET_MARGINS )
{ 
   lxw_chartsheet *self = zh_parptr( 1 ) ;
...
*/
ZH_FUNC( CHARTSHEET_SET_HEADER_OPT )
{ 
   lxw_chartsheet *self = zh_parptr( 1 ) ;
   const char *string = zh_parcx( 2 ) ;
   lxw_header_footer_options *options = zh_parptr( 3 ) ;

   zh_retni( chartsheet_set_header_opt(self, string, options) ); 
}
...
chartsheet_set_footer_opt(lxw_chartsheet *self, const char *string,
            lxw_header_footer_options *options)
*/
ZH_FUNC( CHARTSHEET_SET_FOOTER_OPT )
{ 
   lxw_chartsheet *self = zh_parptr( 1 ) ;
   const char *string = zh_parcx( 2 ) ;
   lxw_header_footer_options *options = zh_parptr( 3 ) ;

   zh_retni( chartsheet_set_footer_opt(self, string, options) ); 
}
...
*/
ZH_FUNC( CHARTSHEET_SET_HEADER )
{ 
   lxw_chartsheet *self = zh_parptr( 1 ) ;
   const char *string = zh_parcx( 2 ) ;

   zh_retni( chartsheet_set_header(self, string) ); 
}
