 ...
 *
 */
ZH_FUNC( LXW_WORKBOOK_FREE )
{ 
   lxw_workbook *workbook = zh_parptr( 1 ) ;
 ...
 *
 */
ZH_FUNC( LXW_WORKBOOK_SET_DEFAULT_XF_INDICES )
{ 
   lxw_workbook *self = zh_parptr( 1 ) ;
 ...
 *
 */
ZH_FUNC( LXW_WORKBOOK_ASSEMBLE_XML_FILE )
{ 
   lxw_workbook *self = zh_parptr( 1 ) ;
 ...
 *
 */
ZH_FUNC( WORKBOOK_NEW )
{ 
   const char *filename = zh_parcx( 1 ) ;

   zh_retptr( workbook_new( filename ) ); 
}
...
*/
ZH_FUNC( NEW_WORKBOOK )
{
   const char *filename = zh_parcx( 1 ) ;
   zh_retptr( workbook_new_opt(filename, NULL) );
}
 ...
 *
 */
ZH_FUNC( WORKBOOK_NEW_OPT )
{
   const char *filename = zh_parcx( 1 );
   lxw_workbook_options *options = zh_param( 2, ZH_IT_ANY );
   if ZH_ISNIL( 2 )
   {
 ...
 *
 */
ZH_FUNC( WORKBOOK_ADD_WORKSHEET )
{ 
   lxw_workbook *self = zh_parptr(1);
   const char *sheetname = zh_parcx( 2 );
   if ZH_ISNIL( 2 ) 
   {
      zh_retptr( workbook_add_worksheet( self, NULL ) );
   }
   else
   {
      zh_retptr( workbook_add_worksheet( self, sheetname ) );
   }
}
 ...
 *
 */
ZH_FUNC( WORKBOOK_ADD_CHARTSHEET )
{ 
   lxw_workbook *self = zh_parptr( 1 ) ;
   const char *sheetname = zh_parcx( 2 ) ;

   zh_retptr( workbook_add_chartsheet( self, sheetname ) ); 
}
 ...
 *
 */
ZH_FUNC( WORKBOOK_ADD_CHART )
{ 
   lxw_workbook *self = zh_parptr( 1 ) ;
   uint8_t type = zh_parni( 2 ) ;

   zh_retptr( workbook_add_chart( self, type ) ); 
}
 ...
 *
 */
ZH_FUNC( WORKBOOK_ADD_FORMAT )
{ 
   lxw_workbook *self = zh_parptr( 1 ) ;

   zh_retptr( workbook_add_format( self ) ); 
}
 ...
 *
 */
ZH_FUNC( WORKBOOK_CLOSE )
{ 
   lxw_workbook *self = zh_parptr( 1 ) ;

   zh_retni( workbook_close( self ) ); 
}
 ...
 *
 */
ZH_FUNC( WORKBOOK_DEFINE_NAME )
{ 
   lxw_workbook *self = zh_parptr( 1 ) ;
   const char *name = zh_parcx( 2 ) ;
   const char *formula = zh_parcx( 3 ) ;

   zh_retni( workbook_define_name( self, name, formula ) ); 
}
 ...
 *
 */
ZH_FUNC( WORKBOOK_SET_PROPERTIES )
{ 
   lxw_workbook *self = zh_parptr( 1 ) ;
   lxw_doc_properties *user_props = zh_parptr(2 ) ;

   zh_retni( workbook_set_properties( self, user_props ) ); 
}
 ...
 *
 */
ZH_FUNC( WORKBOOK_SET_CUSTOM_PROPERTY_STRING )
{ 
   lxw_workbook *self = zh_parptr( 1 ) ;
   const char *name = zh_parcx( 2 ) ;
   const char *value = zh_parcx( 3 ) ;

   zh_retni( workbook_set_custom_property_string( self, name, value ) ); 
}
 ...
 *
 */
ZH_FUNC( WORKBOOK_SET_CUSTOM_PROPERTY_NUMBER )
{ 
   lxw_workbook *self = zh_parptr( 1 ) ;
   const char *name = zh_parcx( 2 ) ;
   double value = zh_parnd( 3 ) ;

   zh_retni( workbook_set_custom_property_number( self, name, value ) ); 
}
 ...
 *
 */
ZH_FUNC( WORKBOOK_SET_CUSTOM_PROPERTY_INTEGER )
{ 
   lxw_workbook *self = zh_parptr( 1 ) ;
   const char *name = zh_parcx( 2 ) ;
   int32_t value = zh_parnl(3 ) ;

   zh_retni( workbook_set_custom_property_integer( self, name, value ) ); 
}
 ...
 *
 */
ZH_FUNC( WORKBOOK_SET_CUSTOM_PROPERTY_BOOLEAN )
{ 
   lxw_workbook *self = zh_parptr( 1 ) ;
   const char *name = zh_parcx( 2 ) ;
   uint8_t value = zh_parni( 3 ) ;

   zh_retni( workbook_set_custom_property_boolean( self, name, value ) ); 
}
 ...
 *
 */
ZH_FUNC( WORKBOOK_SET_CUSTOM_PROPERTY_DATETIME )
{ 
   lxw_workbook *self = zh_parptr( 1 ) ;
   const char *name = zh_parcx( 2 ) ;
   lxw_datetime *datetime = zh_parptr(3 ) ;

   zh_retni( workbook_set_custom_property_datetime( self, name, datetime ) ); 
}
 ...
 *
 */
ZH_FUNC( WORKBOOK_GET_WORKSHEET_BY_NAME )
{ 
   lxw_workbook *self = zh_parptr( 1 ) ;
   const char *name = zh_parcx( 2 ) ;

   zh_retptr( workbook_get_worksheet_by_name( self, name ) ); 
}
 ...
 *
 */
ZH_FUNC( WORKBOOK_GET_CHARTSHEET_BY_NAME )
{ 
   lxw_workbook *self = zh_parptr( 1 ) ;
   const char *name = zh_parcx( 2 ) ;

   zh_retptr( workbook_get_chartsheet_by_name( self, name ) ); 
}
