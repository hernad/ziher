 ...
 * 
 */
ZH_FUNC( LXW_FORMAT_FREE )
{ 
   lxw_format *format = zh_parptr( 1 ) ;
 ...
 *
 */
ZH_FUNC( LXW_FORMAT_CHECK_COLOR )
{ 
   lxw_color_t color = zh_parnl( 1 ) ;

   zh_retnl( lxw_format_check_color( color ) ); 
}
 ...
 *
 */
ZH_FUNC( LXW_FORMAT_GET_FONT_KEY )
{ 
   lxw_format *self = zh_parptr(1 ) ;

   zh_retptr( lxw_format_get_font_key( self ) ); 
}
 ...
 *
 */
ZH_FUNC( LXW_FORMAT_GET_BORDER_KEY )
{ 
   lxw_format *self = zh_parptr( 1 ) ;

   zh_retptr( lxw_format_get_border_key( self ) ); 
}
 ...
 *
 */
ZH_FUNC( LXW_FORMAT_GET_FILL_KEY )
{ 
   lxw_format *self = zh_parptr( 1 ) ;

   zh_retptr( lxw_format_get_fill_key( self ) ); 
}
 ...
 *
 */
ZH_FUNC( LXW_FORMAT_GET_XF_INDEX )
{ 
   lxw_format *self = zh_parptr(1 ) ;

   zh_retnl( lxw_format_get_xf_index( self ) ); 
}
 ...
 *
 */
ZH_FUNC( FORMAT_SET_FONT_NAME )
{ 
   lxw_format *self = zh_parptr( 1 ) ;
   const char *font_name = zh_parcx( 2 ) ;
 ...
 *
 */
ZH_FUNC( FORMAT_SET_FONT_SIZE )
{ 
   lxw_format *self = zh_parptr( 1 ) ;
   double size = zh_parnd( 2 ) ;
 ...
 *
 */
ZH_FUNC( FORMAT_SET_UNDERLINE )
{ 
   lxw_format *self = zh_parptr( 1 ) ;
   uint8_t style = zh_parni( 2 ) ;
 ...
 *
 */
ZH_FUNC( FORMAT_SET_FONT_STRIKEOUT )
{ 
   lxw_format *self = zh_parptr( 1 ) ;
 ...
 *
 */
ZH_FUNC( FORMAT_SET_FONT_SCRIPT )
{ 
   lxw_format *self = zh_parptr( 1 ) ;
   uint8_t style = zh_parni( 2 ) ;
 ...
 *
 */
ZH_FUNC( FORMAT_SET_FONT_OUTLINE )
{ 
   lxw_format *self = zh_parptr(1 ) ;
 ...
 *
 */
ZH_FUNC( FORMAT_SET_FONT_SHADOW )
{ 
   lxw_format *self = zh_parptr( 1 ) ;
 ...
 *
 */
ZH_FUNC( FORMAT_SET_ALIGN )
{ 
   lxw_format *self = zh_parptr( 1 ) ;
   uint8_t value = zh_parni( 2 ) ;
 ...
 *
 */
ZH_FUNC( FORMAT_SET_ROTATION )
{ 
   lxw_format *self = zh_parptr( 1 ) ;
   int16_t angle = zh_parnl( 2 ) ;
 ...
 */
/*
ZH_FUNC( FORMAT_SET_TEXT_JUSTLAST )
{ 
   lxw_format *self = zh_parptr( 1 ) ;
 ...
 *
 */
ZH_FUNC( FORMAT_SET_BORDER_COLOR )
{ 
   lxw_format *self = zh_parptr( 1 ) ;
   lxw_color_t color = zh_parnl( 2 ) ;
 ...
 *
 */
ZH_FUNC( FORMAT_SET_BOTTOM_COLOR )
{ 
   lxw_format *self = zh_parptr( 1 ) ;
   lxw_color_t color = zh_parnl( 2 ) ;
 ...
 *
 */
ZH_FUNC( FORMAT_SET_RIGHT_COLOR )
{ 
   lxw_format *self = zh_parptr(1 ) ;
   lxw_color_t color = zh_parnl(2 ) ;
 ...
 *
 */
ZH_FUNC( FORMAT_SET_DIAG_BORDER )
{ 
   lxw_format *self = zh_parptr( 1 ) ;
   uint8_t style = zh_parni( 2 ) ;
 ...
 *
 */
ZH_FUNC( FORMAT_SET_NUM_FORMAT_INDEX )
{ 
   lxw_format *self = zh_parptr( 1 ) ;
   uint8_t value = zh_parni( 2 ) ;
 ...
 *
 */
ZH_FUNC( FORMAT_SET_READING_ORDER )
{ 
   lxw_format *self = zh_parptr( 1 ) ;
   uint8_t value = zh_parni( 2 ) ;
 ...
 *
 */
ZH_FUNC( FORMAT_SET_FONT_FAMILY )
{ 
   lxw_format *self = zh_parptr( 1 ) ;
   uint8_t value = zh_parni( 2 ) ;
 ...
 *
 */
ZH_FUNC( FORMAT_SET_FONT_CHARSET )
{ 
   lxw_format *self = zh_parptr( 1 ) ;
   uint8_t value = zh_parni( 2 ) ;
 ...
 *
 */
ZH_FUNC( FORMAT_SET_FONT_SCHEME )
{ 
   lxw_format *self = zh_parptr( 1 ) ;
   const char *font_scheme = zh_parcx( 2 ) ;
 ...
 *
 */
ZH_FUNC( FORMAT_SET_FONT_CONDENSE )
{ 
   lxw_format *self = zh_parptr( 1 ) ;
 ...
 *
 */
ZH_FUNC( FORMAT_SET_FONT_EXTEND )
{ 
   lxw_format *self = zh_parptr( 1 ) ;
