...
*/
ZH_FUNC( LXW_CHART_FREE )
{ 
   lxw_chart *chart = zh_parptr( 1 ) ;
...
*/
ZH_FUNC( LXW_CHART_NEW )
{ 
   uint8_t type = zh_parni( 1 ) ;

   zh_retptr( lxw_chart_new(type) ); 
}
...
*/
/*
ZH_FUNC( _CHART_AXIS_SET_DEFAULT_NUM_FORMAT )
{ 
   lxw_chart_axis *axis = zh_parptr( 1 ) ;
   char *num_format = zh_parcx( 2 ) ;
...
*/
/*
ZH_FUNC( _CHART_CHECK_ERROR_BARS )
{ 
   lxw_series_error_bars *error_bars = zh_parptr( 1 ) ;
   char *property = zh_parcx( 2 ) ;

   zh_retni( _chart_check_error_bars(error_bars, property) ); 
}
*/
...
*/
ZH_FUNC( LXW_CHART_ASSEMBLE_XML_FILE )
{ 
   lxw_chart *self = zh_parptr( 1 ) ;
...
*/
ZH_FUNC( LXW_CHART_ADD_DATA_CACHE )
{ 
   lxw_series_range *range = zh_parptr( 1 ) ;
   uint8_t *data = zh_parptr( 2 ) ;
   uint16_t rows = zh_parnl( 3 ) ;
   uint8_t cols = zh_parni( 4 ) ;
   uint8_t col = zh_parni( 5 ) ;

   zh_retni( lxw_chart_add_data_cache(range, data, rows, cols, col) ); 
}
...
*/
ZH_FUNC( CHART_ADD_SERIES )
{ 
   lxw_chart *self = zh_parptr( 1 ) ;
   const char *categories = zh_parcx( 2 ) ;
   const char *values = zh_parcx( 3 ) ;

   zh_retptr( chart_add_series(self, categories, values) ); 
}
...
*/
ZH_FUNC( CHART_SET_STYLE )
{ 
   lxw_chart *self = zh_parptr( 1 ) ;
   uint8_t style_id = zh_parni( 2 ) ;
...
*/
ZH_FUNC( CHART_SERIES_SET_NAME )
{ 
   lxw_chart_series *series = zh_parptr( 1 ) ;
...
*/
ZH_FUNC( CHART_SERIES_SET_NAME_RANGE )
{ 
   lxw_chart_series *series = zh_parptr( 1 ) ;
   const char *sheetname = zh_parcx( 2 ) ;
   lxw_row_t row = zh_parni( 3 ) ;
   lxw_col_t col = zh_parni( 4 ) ;
...
*/
ZH_FUNC( CHART_SERIES_SET_CATEGORIES )
{ 
   lxw_chart_series *series = zh_parptr( 1 ) ;
   const char *sheetname = zh_parcx( 2 ) ;
...
chart_series_set_values(lxw_chart_series *series, const char *sheetname,
   ...
   lxw_row_t last_row, lxw_col_t last_col)
*/
ZH_FUNC( CHART_SERIES_SET_VALUES )
{ 
   lxw_chart_series *series = zh_parptr( 1 ) ;
   const char *sheetname = zh_parcx( 2 ) ;
   lxw_row_t first_row = zh_parni( 3 ) ;
...
*/
ZH_FUNC( CHART_SERIES_SET_LINE )
{ 
   lxw_chart_series *series = zh_parptr( 1 ) ;
   lxw_chart_line *line = zh_parptr( 2 ) ;
...
*/
ZH_FUNC( CHART_SERIES_SET_FILL )
{ 
   lxw_chart_series *series = zh_parptr( 1 ) ;
   lxw_chart_fill *fill = zh_parptr( 2 ) ;
...
*/
ZH_FUNC( CHART_SERIES_SET_INVERT_IF_NEGATIVE )
{ 
   lxw_chart_series *series = zh_parptr( 1 ) ;
...
*/
ZH_FUNC( CHART_SERIES_SET_PATTERN )
{ 
   lxw_chart_series *series = zh_parptr( 1 ) ;
   lxw_chart_pattern *pattern = zh_parptr( 2 ) ;
...
*/
ZH_FUNC( CHART_SERIES_SET_MARKER_TYPE )
{ 
   lxw_chart_series *series = zh_parptr( 1 ) ;
   uint8_t type = zh_parni( 2 ) ;
...
*/
ZH_FUNC( CHART_SERIES_SET_MARKER_SIZE )
{ 
   lxw_chart_series *series = zh_parptr( 1 ) ;
   uint8_t size = zh_parni( 2 ) ;
...
*/
ZH_FUNC( CHART_SERIES_SET_MARKER_LINE )
{ 
   lxw_chart_series *series = zh_parptr( 1 ) ;
   lxw_chart_line *line = zh_parptr( 2 ) ;
...
*/
ZH_FUNC( CHART_SERIES_SET_MARKER_FILL )
{ 
   lxw_chart_series *series = zh_parptr( 1 ) ;
   lxw_chart_fill *fill = zh_parptr( 2 ) ;
...
*/
ZH_FUNC( CHART_SERIES_SET_MARKER_PATTERN )
{ 
   lxw_chart_series *series = zh_parptr( 1 ) ;
   lxw_chart_pattern *pattern = zh_parptr( 2 ) ;
...
*/
/*
ZH_FUNC( CHART_SERIES_SET_POINTS )
{ 
   lxw_chart_series *series = zh_parptr( 1 ) ;
   lxw_chart_point *points[] = zh_parptr( 2 ) ;

   zh_retni( chart_series_set_points(series, points[]) ); 
}
*/
...
*/
ZH_FUNC( CHART_SERIES_SET_SMOOTH )
{ 
   lxw_chart_series *series = zh_parptr( 1 ) ;
   uint8_t smooth = zh_parni( 2 ) ;
...
*/
ZH_FUNC( CHART_SERIES_SET_LABELS )
{ 
   lxw_chart_series *series = zh_parptr( 1 ) ;
...
*/
ZH_FUNC( CHART_SERIES_SET_LABELS_OPTIONS )
{ 
   lxw_chart_series *series = zh_parptr( 1 ) ;
   uint8_t show_name = zh_parni( 2 ) ;
   uint8_t show_category = zh_parni( 3 ) ;
   uint8_t show_value = zh_parni( 4 ) ;
...
*/
ZH_FUNC( CHART_SERIES_SET_LABELS_SEPARATOR )
{ 
   lxw_chart_series *series = zh_parptr( 1 ) ;
   uint8_t separator = zh_parni( 2 ) ;
...
*/
ZH_FUNC( CHART_SERIES_SET_LABELS_POSITION )
{ 
   lxw_chart_series *series = zh_parptr( 1 ) ;
   uint8_t position = zh_parni( 2 ) ;
...
*/
ZH_FUNC( CHART_SERIES_SET_LABELS_LEADER_LINE )
{ 
   lxw_chart_series *series = zh_parptr( 1 ) ;
...
*/
ZH_FUNC( CHART_SERIES_SET_LABELS_LEGEND )
{ 
   lxw_chart_series *series = zh_parptr( 1 ) ;
...
*/
ZH_FUNC( CHART_SERIES_SET_LABELS_PERCENTAGE )
{ 
   lxw_chart_series *series = zh_parptr( 1 ) ;
...
*/
ZH_FUNC( CHART_SERIES_SET_LABELS_NUM_FORMAT )
{ 
   lxw_chart_series *series = zh_parptr( 1 ) ;
   const char *num_format = zh_parcx( 2 ) ;
...
*/
ZH_FUNC( CHART_SERIES_SET_LABELS_FONT )
{ 
   lxw_chart_series *series = zh_parptr( 1 ) ;
   lxw_chart_font *font = zh_parptr( 2 ) ;
...
chart_series_set_trendline(lxw_chart_series *series, uint8_t type,
   uint8_t value)
*/
ZH_FUNC( CHART_SERIES_SET_TRENDLINE )
{ 
   lxw_chart_series *series = zh_parptr( 1 ) ;
   uint8_t type = zh_parni( 2 ) ;
   uint8_t value = zh_parni( 3 ) ;
...
chart_series_set_trendline_forecast(lxw_chart_series *series, double forward,
   double backward)
*/
ZH_FUNC( CHART_SERIES_SET_TRENDLINE_FORECAST )
{ 
   lxw_chart_series *series = zh_parptr( 1 ) ;
   double forward = zh_parnd( 2 ) ;
   double backward = zh_parnd( 3 ) ;
...
*/
ZH_FUNC( CHART_SERIES_SET_TRENDLINE_EQUATION )
{ 
   lxw_chart_series *series = zh_parptr( 1 ) ;
...
*/
ZH_FUNC( CHART_SERIES_SET_TRENDLINE_R_SQUARED )
{ 
   lxw_chart_series *series = zh_parptr( 1 ) ;
...
chart_series_set_trendline_intercept(lxw_chart_series *series,
   double intercept)
*/
ZH_FUNC( CHART_SERIES_SET_TRENDLINE_INTERCEPT )
{ 
   lxw_chart_series *series = zh_parptr( 1 ) ;
   double intercept = zh_parnd( 2 ) ;
...
*/
ZH_FUNC( CHART_SERIES_SET_TRENDLINE_NAME )
{ 
   lxw_chart_series *series = zh_parptr( 1 ) ;
   const char *name = zh_parcx( 2 ) ;
...
chart_series_set_trendline_line(lxw_chart_series *series,
   lxw_chart_line *line)
*/
ZH_FUNC( CHART_SERIES_SET_TRENDLINE_LINE )
{ 
   lxw_chart_series *series = zh_parptr( 1 ) ;
   lxw_chart_line *line = zh_parptr( 2 ) ;
...
*/
/*
ZH_FUNC( CHART_SERIES_GET_ERROR_BARS )
{ 
   lxw_chart_series *series = zh_parptr( 1 ) ;
   lxw_chart_error_bar_axis axis_type = zh_parptr( 2 ) ;

   zh_retptr( chart_series_get_error_bars(series, axis_type) ); 
}
*/
...
*/
ZH_FUNC( CHART_SERIES_SET_ERROR_BARS )
{ 
   lxw_series_error_bars *error_bars = zh_parptr( 1 ) ;
   uint8_t type = zh_parni( 2 ) ;
   double value = zh_parnd( 3 ) ;
...
chart_series_set_error_bars_direction(lxw_series_error_bars *error_bars,
   uint8_t direction)
*/
ZH_FUNC( CHART_SERIES_SET_ERROR_BARS_DIRECTION )
{ 
   lxw_series_error_bars *error_bars = zh_parptr( 1 ) ;
   uint8_t direction = zh_parni( 2 ) ;
...
chart_series_set_error_bars_endcap(lxw_series_error_bars *error_bars,
   uint8_t endcap)
*/
ZH_FUNC( CHART_SERIES_SET_ERROR_BARS_ENDCAP )
{ 
   lxw_series_error_bars *error_bars = zh_parptr( 1 ) ;
   uint8_t endcap = zh_parni( 2 ) ;
...
chart_series_set_error_bars_line(lxw_series_error_bars *error_bars,
   lxw_chart_line *line)
*/
ZH_FUNC( CHART_SERIES_SET_ERROR_BARS_LINE )
{ 
   lxw_series_error_bars *error_bars = zh_parptr( 1 ) ;
   lxw_chart_line *line = zh_parptr( 2 ) ;
...
*/
ZH_FUNC( CHART_AXIS_GET )
{ 
   lxw_chart *self = zh_parptr( 1 ) ;
   lxw_chart_axis_type axis_type = zh_parni( 2 ) ;

   zh_retptr( chart_axis_get(self, axis_type) ); 
}
...
chart_axis_set_name_range(lxw_chart_axis *axis, const char *sheetname,
   lxw_row_t row, lxw_col_t col)
*/
ZH_FUNC( CHART_AXIS_SET_NAME_RANGE )
{ 
   lxw_chart_axis *axis = zh_parptr( 1 ) ;
   const char *sheetname = zh_parcx( 2 ) ;
   lxw_row_t row = zh_parni( 3 ) ;
...
*/
ZH_FUNC( CHART_AXIS_SET_NAME_FONT )
{ 
   lxw_chart_axis *axis = zh_parptr( 1 ) ;
   lxw_chart_font *font = zh_parptr( 2 ) ;
...
*/
ZH_FUNC( CHART_AXIS_SET_NUM_FONT )
{ 
   lxw_chart_axis *axis = zh_parptr( 1 ) ;
   lxw_chart_font *font = zh_parptr( 2 ) ;
...
*/
ZH_FUNC( CHART_AXIS_SET_NUM_FORMAT )
{ 
   lxw_chart_axis *axis = zh_parptr( 1 ) ;
   const char *num_format = zh_parcx( 2 ) ;
...
*/
ZH_FUNC( CHART_AXIS_SET_PATTERN )
{ 
   lxw_chart_axis *axis = zh_parptr( 1 ) ;
   lxw_chart_pattern *pattern = zh_parptr( 2 ) ;
...
*/
ZH_FUNC( CHART_AXIS_SET_REVERSE )
{ 
   lxw_chart_axis *axis = zh_parptr( 1 ) ;
...
*/
ZH_FUNC( CHART_AXIS_SET_CROSSING )
{ 
   lxw_chart_axis *axis = zh_parptr( 1 ) ;
   double value = zh_parnd( 2 ) ;
...
*/
ZH_FUNC( CHART_AXIS_SET_CROSSING_MAX )
{ 
   lxw_chart_axis *axis = zh_parptr( 1 ) ;
...
*/
ZH_FUNC( CHART_AXIS_SET_POSITION )
{ 
   lxw_chart_axis *axis = zh_parptr( 1 ) ;
   uint8_t position = zh_parni( 2 ) ;
...
*/
ZH_FUNC( CHART_AXIS_SET_LABEL_POSITION )
{ 
   lxw_chart_axis *axis = zh_parptr( 1 ) ;
   uint8_t position = zh_parni( 2 ) ;
...
*/
ZH_FUNC( CHART_AXIS_SET_MIN )
{ 
   lxw_chart_axis *axis = zh_parptr( 1 ) ;
   double min = zh_parnd( 2 ) ;
...
*/
ZH_FUNC( CHART_AXIS_SET_MAX )
{ 
   lxw_chart_axis *axis = zh_parptr( 1 ) ;
   double max = zh_parnd( 2 ) ;
...
*/
ZH_FUNC( CHART_AXIS_SET_LOG_BASE )
{ 
   lxw_chart_axis *axis = zh_parptr( 1 ) ;
   uint16_t log_base = zh_parnl( 2 ) ;
...
*/
ZH_FUNC( CHART_AXIS_SET_MAJOR_TICK_MARK )
{ 
   lxw_chart_axis *axis = zh_parptr( 1 ) ;
   uint8_t type = zh_parni( 2 ) ;
...
*/
ZH_FUNC( CHART_AXIS_SET_MINOR_TICK_MARK )
{ 
   lxw_chart_axis *axis = zh_parptr( 1 ) ;
   uint8_t type = zh_parni( 2 ) ;
...
*/
ZH_FUNC( CHART_AXIS_SET_INTERVAL_UNIT )
{ 
   lxw_chart_axis *axis = zh_parptr( 1 ) ;
   uint16_t unit = zh_parnl( 2 ) ;
...
*/
ZH_FUNC( CHART_AXIS_SET_INTERVAL_TICK )
{ 
   lxw_chart_axis *axis = zh_parptr( 1 ) ;
   uint16_t unit = zh_parnl( 2 ) ;
...
*/
ZH_FUNC( CHART_AXIS_SET_MAJOR_UNIT )
{ 
   lxw_chart_axis *axis = zh_parptr( 1 ) ;
   double unit = zh_parnd( 2 ) ;
...
*/
ZH_FUNC( CHART_AXIS_SET_MINOR_UNIT )
{ 
   lxw_chart_axis *axis = zh_parptr( 1 ) ;
   double unit = zh_parnd( 2 ) ;
...
*/
ZH_FUNC( CHART_AXIS_SET_DISPLAY_UNITS )
{ 
   lxw_chart_axis *axis = zh_parptr( 1 ) ;
   uint8_t units = zh_parni( 2 ) ;
...
*/
ZH_FUNC( CHART_AXIS_SET_DISPLAY_UNITS_VISIBLE )
{ 
   lxw_chart_axis *axis = zh_parptr( 1 ) ;
...
*/
ZH_FUNC( CHART_AXIS_MAJOR_GRIDLINES_SET_VISIBLE )
{ 
   lxw_chart_axis *axis = zh_parptr( 1 ) ;
   uint8_t visible = zh_parni( 2 ) ;
...
chart_axis_major_gridlines_set_line(lxw_chart_axis *axis,
   lxw_chart_line *line)
*/
ZH_FUNC( CHART_AXIS_MAJOR_GRIDLINES_SET_LINE )
{ 
   lxw_chart_axis *axis = zh_parptr( 1 ) ;
   lxw_chart_line *line = zh_parptr( 2 ) ;
...
*/
ZH_FUNC( CHART_AXIS_MINOR_GRIDLINES_SET_VISIBLE )
{ 
   lxw_chart_axis *axis = zh_parptr( 1 ) ;
   uint8_t visible = zh_parni( 2 ) ;
...
chart_axis_minor_gridlines_set_line(lxw_chart_axis *axis,
   lxw_chart_line *line)
*/
ZH_FUNC( CHART_AXIS_MINOR_GRIDLINES_SET_LINE )
{ 
   lxw_chart_axis *axis = zh_parptr( 1 ) ;
   lxw_chart_line *line = zh_parptr( 2 ) ;
...
*/
ZH_FUNC( CHART_AXIS_SET_LABEL_ALIGN )
{ 
   lxw_chart_axis *axis = zh_parptr( 1 ) ;
   uint8_t align = zh_parni( 2 ) ;
...
chart_title_set_name_range(lxw_chart *self, const char *sheetname,
   lxw_row_t row, lxw_col_t col)
*/
ZH_FUNC( CHART_TITLE_SET_NAME_RANGE )
{ 
   lxw_chart *self = zh_parptr( 1 ) ;
   const char *sheetname = zh_parcx( 2 ) ;
   lxw_row_t row = zh_parni( 3 ) ;
...
*/
ZH_FUNC( CHART_TITLE_SET_NAME_FONT )
{ 
   lxw_chart *self = zh_parptr( 1 ) ;
   lxw_chart_font *font = zh_parptr( 2 ) ;
...
*/
ZH_FUNC( CHART_LEGEND_SET_POSITION )
{ 
   lxw_chart *self = zh_parptr( 1 ) ;
   uint8_t position = zh_parni( 2 ) ;
...
*/
/*
ZH_FUNC( CHART_LEGEND_DELETE_SERIES )
{ 
   lxw_chart *self = zh_parptr( 1 ) ;
   int16_t delete_series[] = zh_parnl( 2 ) ;

   zh_retni( chart_legend_delete_series(self, delete_series[]) ); 
}
*/
...
*/
ZH_FUNC( CHART_CHARTAREA_SET_LINE )
{ 
   lxw_chart *self = zh_parptr( 1 ) ;
   lxw_chart_line *line = zh_parptr( 2 ) ;
...
*/
ZH_FUNC( CHART_CHARTAREA_SET_FILL )
{ 
   lxw_chart *self = zh_parptr( 1 ) ;
   lxw_chart_fill *fill = zh_parptr( 2 ) ;
...
*/
ZH_FUNC( CHART_CHARTAREA_SET_PATTERN )
{ 
   lxw_chart *self = zh_parptr( 1 ) ;
   lxw_chart_pattern *pattern = zh_parptr( 2 ) ;
...
*/
ZH_FUNC( CHART_PLOTAREA_SET_LINE )
{ 
   lxw_chart *self = zh_parptr( 1 ) ;
   lxw_chart_line *line = zh_parptr( 2 ) ;
...
*/
ZH_FUNC( CHART_PLOTAREA_SET_FILL )
{ 
   lxw_chart *self = zh_parptr( 1 ) ;
   lxw_chart_fill *fill = zh_parptr( 2 ) ;
...
*/
ZH_FUNC( CHART_PLOTAREA_SET_PATTERN )
{ 
   lxw_chart *self = zh_parptr( 1 ) ;
   lxw_chart_pattern *pattern = zh_parptr( 2 ) ;
...
*/
ZH_FUNC( CHART_SET_TABLE_GRID )
{ 
   lxw_chart *self = zh_parptr( 1 ) ;
   uint8_t horizontal = zh_parni( 2 ) ;
   uint8_t vertical = zh_parni( 3 ) ;
   uint8_t outline = zh_parni( 4 ) ;
   uint8_t legend_keys = zh_parni( 5 ) ;
...
*/
ZH_FUNC( CHART_SET_UP_DOWN_BARS )
{ 
   lxw_chart *self = zh_parptr( 1 ) ;
...
*/
ZH_FUNC( CHART_SET_UP_DOWN_BARS_FORMAT )
{ 
   lxw_chart *self = zh_parptr( 1 ) ;
   lxw_chart_line *up_bar_line = zh_parptr( 2 ) ;
   lxw_chart_fill *up_bar_fill = zh_parptr( 3 ) ;
   lxw_chart_line *down_bar_line = zh_parptr( 4 ) ;
   lxw_chart_fill *down_bar_fill = zh_parptr( 5 ) ;
...
*/
ZH_FUNC( CHART_SET_HIGH_LOW_LINES )
{ 
   lxw_chart *self = zh_parptr( 1 ) ;
   lxw_chart_line *line = zh_parptr( 2 ) ;
...
*/
ZH_FUNC( CHART_SET_SERIES_OVERLAP )
{ 
   lxw_chart *self = zh_parptr( 1 ) ;
   int8_t overlap = zh_parni( 2 ) ;
...
*/
ZH_FUNC( CHART_SHOW_HIDDEN_DATA )
{ 
   lxw_chart *self = zh_parptr( 1 ) ;
...
*/
ZH_FUNC( CHART_SET_SERIES_GAP )
{ 
   lxw_chart *self = zh_parptr( 1 ) ;
   uint16_t gap = zh_parnl( 2 ) ;
...
*/
ZH_FUNC( CHART_SET_ROTATION )
{ 
   lxw_chart *self = zh_parptr( 1 ) ;
   uint16_t rotation = zh_parnl( 2 ) ;
