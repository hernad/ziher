...
*/
ZH_FUNC( LXW_CONTENT_TYPES_NEW )
{ 
   zh_retptr( lxw_content_types_new() ); 
}
...
*/
ZH_FUNC( LXW_CONTENT_TYPES_FREE )
{ 
   lxw_content_types *content_types = zh_parptr( 1 ) ;
...
*/
ZH_FUNC( LXW_CONTENT_TYPES_ASSEMBLE_XML_FILE )
{ 
   lxw_content_types *self = zh_parptr( 1 ) ;
...
lxw_ct_add_default(lxw_content_types *self, const char *key,
   const char *value)
*/
ZH_FUNC( LXW_CT_ADD_DEFAULT )
{ 
   lxw_content_types *self = zh_parptr( 1 ) ;
   const char *key = zh_parcx( 2 ) ;
...
*/
ZH_FUNC( LXW_CT_ADD_WORKSHEET_NAME )
{ 
   lxw_content_types *self = zh_parptr( 1 ) ;
...
*/
ZH_FUNC( LXW_CT_ADD_CHARTSHEET_NAME )
{ 
   lxw_content_types *self = zh_parptr( 1 ) ;
   const char *name = zh_parcx( 2 ) ;
...
*/
ZH_FUNC( LXW_CT_ADD_DRAWING_NAME )
{ 
   lxw_content_types *self = zh_parptr( 1 ) ;
   const char *name = zh_parcx( 2 ) ;
...
*/
ZH_FUNC( LXW_CT_ADD_SHARED_STRINGS )
{ 
   lxw_content_types *self = zh_parptr( 1 ) ;
