...
ZH_FUNC( HPDF_PDFA_SETPDFACONFORMANCE )
{
/* FIXME: These functions are not exported from libharu. Until we find
          ...
          builds. [vszakats] */
#if ZH_HPDF_VERS( 2, 2, 0 ) && ! defined( ZH_DYNLIB )
   zh_retnl( HPDF_PDFA_SetPDFAConformance( zh_HPDF_Doc_par( 1 ), ( HPDF_PDFAType ) zh_parni( 2 ) ) );
#else
