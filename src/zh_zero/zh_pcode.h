...
/* end: */
   ...
   ZH_P_PUSH_ALIASED_FIELDNEAR,  /*  87 pushes aliased field */
   ZH_P_PUSHALIASEDVAR,        /*  88 pushes aliased variable (either a field or a memvar) */
   ZH_P_PUSH_BLOCK,             /*  89 start of a codeblock definition */
   ZH_P_PUSH_BLOCKSHORT,        /*  90 start of a codeblock definition */
   ...
   ZH_P_PUSH_DATE,              /* 134 places a data constant value on the virtual machine stack */
/* optimization of inlined math operations */
   ...
   ZH_P_MACRO_SEND,             /* 146 send operator with macro list params */
   ...
   ZH_P_PUSH_STR_HIDDEN,         /* 152 places a "hidden" string on the virtual machine stack */
   ...
   ZH_P_MPUSH_BLOCKLARGE,       /* 159 code block generated by the macro compiler larger then 64 KiB */
   ZH_P_MPUSHSTRLARGE,         /* 160 Macro compiled pushed string */
   ZH_P_PUSH_BLOCKLARGE,        /* 161 start of a codeblock definition */
   ...
   ZH_P_PUSHVPARAMS,           /* 164 push variable function/method parameters on ZHVM stack */
   ZH_P_PUSHUNREF,             /* 165 push unreferenced top item on ZHVM stack */
   ...
   ZH_P_PUSHAPARAMS,           /* 180 push array items on ZHVM stack */
