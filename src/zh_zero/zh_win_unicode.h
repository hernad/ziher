...
#if defined( UNICODE )
   #define ZH_PARSTR( n, h, len )                zh_parstr_u16( n, ZH_CODEPAGE_ENDIAN_NATIVE, h, len )
   #define ZH_PARSTRDEF( n, h, len )             zh_wstrnull( zh_parstr_u16( n, ZH_CODEPAGE_ENDIAN_NATIVE, h, len ) )
   #define ZH_PARASTR( n, i, h, len )            zh_parastr_u16( n, i, ZH_CODEPAGE_ENDIAN_NATIVE, h, len )
   #define ZH_PARASTRDEF( n, i, h, len )         zh_wstrnull( zh_parastr_u16( n, i, ZH_CODEPAGE_ENDIAN_NATIVE, h, len ) )
   #define ZH_RETSTR( str )                      zh_retstr_u16( ZH_CODEPAGE_ENDIAN_NATIVE, str )
   #define ZH_RETSTRLEN( str, len )              zh_retstrlen_u16( ZH_CODEPAGE_ENDIAN_NATIVE, str, len )
   #define ZH_STORSTR( str, n )                  zh_storstr_u16( ZH_CODEPAGE_ENDIAN_NATIVE, str, n )
   #define ZH_STORSTRLEN( str, len, n )          zh_storstrlen_u16( ZH_CODEPAGE_ENDIAN_NATIVE, str, len, n )
   #define ZH_ARRAYGETSTR( arr, n, phstr, plen ) zh_arrayGetStrU16( arr, n, ZH_CODEPAGE_ENDIAN_NATIVE, phstr, plen )
   #define ZH_ARRAYSETSTR( arr, n, str )         zh_arraySetStrU16( arr, n, ZH_CODEPAGE_ENDIAN_NATIVE, str )
   #define ZH_ARRAYSETSTRLEN( arr, n, str, len ) zh_arraySetStrLenU16( arr, n, ZH_CODEPAGE_ENDIAN_NATIVE, str, len )
   #define ZH_ITEMCOPYSTR( itm, str, len )       zh_itemCopyStrU16( itm, ZH_CODEPAGE_ENDIAN_NATIVE, str, len )
   #define ZH_ITEMGETSTR( itm, phstr, plen )     zh_itemGetStrU16( itm, ZH_CODEPAGE_ENDIAN_NATIVE, phstr, plen )
   #define ZH_ITEMPUTSTR( itm, str )             zh_itemPutStrU16( itm, ZH_CODEPAGE_ENDIAN_NATIVE, str )
   #define ZH_ITEMPUTSTRLEN( itm, str, len )     zh_itemPutStrLenU16( itm, ZH_CODEPAGE_ENDIAN_NATIVE, str, len )
