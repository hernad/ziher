...
ZH_FUNC( SPACE )
{
   ...
   if( pItem )
   {
      ...
      if( nLen > 0 )
      {
         ...
         #if 0
         zh_errRT_BASE( EG_STROVERFLOW, 1233, NULL, ZH_ERR_FUNCNAME, ZH_ERR_ARGS_BASEPARAMS );
         #endif
      ...
      zh_errRT_BASE_SubstR( EG_ARG, 1105, NULL, ZH_ERR_FUNCNAME, ZH_ERR_ARGS_BASEPARAMS );
}
