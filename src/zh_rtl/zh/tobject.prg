...
FUNCTION HBObject()
   ...
   IF s_oClass == NIL .AND. __clsLockDef( @s_oClass )
      ...
      BEGIN SEQUENCE
         ...
         oClass:AddMethod( "NEW"  , @HBObject_New()   , ZH_OO_CLSTP_EXPORTED )
         oClass:AddMethod( "INIT" , @HBObject_Init()  , ZH_OO_CLSTP_EXPORTED )

         oClass:AddMethod( "ERROR", @HBObject_Error() , ZH_OO_CLSTP_EXPORTED )
