/*
 * POPUP menu class (Ziher extended)
 *
...
CREATE CLASS zh_PopupMenu INHERIT HBPopupMenu
...
METHOD shadowed( lShadowed ) CLASS zh_PopupMenu
...
METHOD setCoors( nRow, nCol, lTop ) CLASS zh_PopupMenu
...
METHOD isShortCut( nKey, /* @ */ nID ) CLASS zh_PopupMenu
...
METHOD isQuick( nKey, /* @ */ nID ) CLASS zh_PopupMenu
