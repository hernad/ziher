...
{
   {
      ...
      "zh_xgrab no puede asignar memoria",
      "zh_xrealloc llamado con un puntero nulo",
      "zh_xrealloc llamado con un puntero no válido",
      "zh_xrealloc no puede reubicar la memoria",
      "zh_xfree llamado con un puntero no válido",
      "zh_xfree llamado con un puntero nulo",
      ...
      "zh_xgrab requirió apartar cero bytes",
      "zh_xrealloc requirió redimensionar a cero bytes",
      "zh_xalloc requirió apartar cero bytes",
