...
{
   {
      ...
      "zh_xgrab не може да задели памет",
      "zh_xrealloc извикана с NULL указател",
      "zh_xrealloc извикана с невалиден указател",
      "zh_xrealloc не може да задели памет",
      "zh_xfree извикана с невалиден указател",
      "zh_xfree извикана с NULL указател",
      ...
      "zh_xgrab заявено да задели нула байта",
      "zh_xrealloc заявено да промени големината на нула байта",
      "zh_xalloc заявено да задели нула байта",
