...
extern ZH_EXPORT ZH_U32 zh_arc4random( void );
extern ZH_EXPORT void zh_arc4random_buf( void * _buf, ZH_SIZE n );
extern ZH_EXPORT ZH_U32 zh_arc4random_uniform( ZH_U32 upper_bound );
