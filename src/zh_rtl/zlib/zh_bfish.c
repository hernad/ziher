...
static const ZH_BLOWFISH s_blowFishInit =
{
...
void zh_blowfishEncrypt( const ZH_BLOWFISH * bf, ZH_U32 * xl, ZH_U32 * xr )
{
   ZH_U32 xL = *xl, xR = *xr;
...
void zh_blowfishDecrypt( const ZH_BLOWFISH * bf, ZH_U32 * xl, ZH_U32 * xr )
{
   ZH_U32 xL = *xl, xR = *xr;
...
void zh_blowfishInit( ZH_BLOWFISH * bf, const void * keydata, int keylen )
{
