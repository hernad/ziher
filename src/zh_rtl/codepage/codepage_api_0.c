...
PZH_CODEPAGE zh_cdpSelect( PZH_CODEPAGE cdp )
{
   PZH_CODEPAGE cdpOld;

   ZH_TRACE( ZH_TR_DEBUG, ( "zh_cdpSelect(%p)", ( void * ) cdp ) );
...
const char * zh_cdpSelectID( const char * id )
{
   PZH_CODEPAGE cdp;

   ZH_TRACE( ZH_TR_DEBUG, ( "zh_cdpSelectID(%s)", id ) );

   cdp = zh_cdpSelect( zh_cdpFindExt( id ) );
