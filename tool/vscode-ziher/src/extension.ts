...
const decorator = require('./client/decorator');
const doc_creator = require('./client/doc_creator');
...
function activate(context) {
	...
	let langCli = new client.LanguageClient('ZiherServer', 'ZHLangServer', serverOptions, clientOptions);
